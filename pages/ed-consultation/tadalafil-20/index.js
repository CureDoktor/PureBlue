...
export default function Tadalafil() {
        ...
        <div className={styles.container}>
          <Container>
            <Row>
              <Col sm={6}>
                <h2>
                  Order Tadalafil <span>(Generic Cialis)</span> in 3 minutes or
                  less!
                </h2>
                <Image
                  className={styles.Image}
                  src="/images/ed-consultation/sachet1000/tadalafil-20mg.png"
                  height={306}
                  width={298}
                />
                <Row>
                  <Col span={6}>
                    <h3>
                      20mg Generic form of Cialis® <span>(Tadalafil)</span>
                    </h3>
                  </Col>
                  <Col span={6}>
