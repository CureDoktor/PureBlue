              ...
              <Col md={6}>
                ...
                <Row>
                  <Col md={8}>
                    ...
                    <ul>
                      <li>Seventeen 30 MG Sildenafil Chewables</li>
                      <li>Discreet shipping to your house</li>
                      <li>FREE online physician consultation.</li>
                      <li>Monthly refills</li>
                      <li>24/7 support</li>
                    </ul>
                  </Col>
                  <Col md={4}>
                ...
                <ul>
                  <li>Automatic refills every 30 days.</li>
                  <li>Cancel anytime. No gimmicks.</li>
                  <li>Payment does not guarantee a prescription.</li>
                  <li>100% refund if no prescription is written.</li>
                </ul>
