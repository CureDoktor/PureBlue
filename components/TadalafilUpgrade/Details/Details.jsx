  ...
  const upgradeArray = [
    {
      ...
      doses: `<strong>12 doses</strong> of 25.0mg Tadalafil (oral - tablet)`,
...

    {
      ...
      doses: `<strong >24 doses</strong> of 25.0mg Tadalafil (oral - tablet)`,
...

    {
      ...
      doses: `<strong>48 doses</strong> of 25.0mg Tadalafil (oral - tablet)`,
    ...
    <div className={styles.mainContainer}>
      ...
      <div className={styles.para}>
        <p>
          ...
          <span>FDA-approved Generic Cialis (Tadalafil oral – tablet)</span>
